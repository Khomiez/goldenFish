...
void Debug_PrintGameState(void) {
    ...
    Log_Print("\r\n");
    Log_Print("========================================\r\n");
    Log_Print("      GOLDEN FISH - DEBUG INFO\r\n");
    Log_Print("========================================\r\n");
    Log_Print("System Time:     %lu ms\r\n", GetTick());
    ...
    Log_Print("Score:           %lu\r\n", g_score);
    Log_Print("Speed Difficulty: %u (1-5)\r\n", g_difficulty);
    Log_Print("\r\n");
    ...
    Log_Print("Pattern Sequence: [");
    const char* led_names[4] = {"BLU", "RED", "YEL", "GRN"};
    ...
    // ADC Values
    Log_Print("--- ADC Values (Potentiometer) ---\r\n");
    Log_Print("POT (Speed Control): %u / 1023 (%.1f%%)\r\n",
              g_adc_values[0], (g_adc_values[0] * 100.0f) / 1023.0f);
    Log_Print("ADC Channel 1:       %u / 1023\r\n", g_adc_values[1]);
    Log_Print("ADC Channel 2:       %u / 1023\r\n", g_adc_values[2]);
    Log_Print("Current Channel:     %u\r\n", g_current_adc_channel);
    Log_Print("\r\n");
